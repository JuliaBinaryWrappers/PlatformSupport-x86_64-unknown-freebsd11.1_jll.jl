module PlatformSupport-x86_64-unknown-freebsd11.1_jll
...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import PlatformSupport-x86_64-unknown-freebsd11.1_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("2aed2f22-358e-509f-8625-949f5f020e5c"))
platforms = [Pkg.Artifacts.unpack_platform(e, "PlatformSupport-x86_64-unknown-freebsd11.1", artifacts_toml) for e in artifacts["PlatformSupport-x86_64-unknown-freebsd11.1"]]
...
if best_platform === nothing
    @debug("Unable to load PlatformSupport-x86_64-unknown-freebsd11.1; unsupported platform $(triplet(platform_key_abi()))")
else
    # Load the appropriate wrapper
    include(joinpath(@__DIR__, "wrappers", "$(best_platform).jl"))
end

end  # module PlatformSupport-x86_64-unknown-freebsd11.1_jll
